...
class transaction:
    def __init__(self, line):
        ...
        self.fraud = line[9]
        self.body = {'customer':self.customer,'age':self.age,'gender':self.gender,'zip':self.zip,'mercant':self.merchant,'merchant zip':self.zipmerchant,'category':self.category,'amount':self.amount,'fraud':self.fraud}
...
def parse_to_list():
    ...
    with open(path, 'r') as fp:
        ...
        for line in readdata:
            if line== ['step', 'customer', 'age', 'gender', 'zipcodeOri', 'merchant', 'zipMerchant', 'category', 'amount', 'fraud']:
                continue
